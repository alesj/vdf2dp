 ...
 */
public class DeploymentPhaseContextAdapter extends AttachmentsAdapter implements VFSDeploymentUnit
{
   private DeploymentPhaseContext context;

   public DeploymentPhaseContextAdapter(DeploymentPhaseContext context)
   {
      super(context);
   ...
   {
      return context.getDeploymentUnit().getName();
   }
